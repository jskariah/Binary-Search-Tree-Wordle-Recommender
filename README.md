...
To build the BSTSet test executable:

```bash
make bstset_tests
```

To build the Wordle test executable:

```bash
make wordle_tests
```

To build the BSTSet main executable:

```bash
make bstset_main
```

To build the Wordle main executable:
...
To run the BSTSet main file:

```bash
make run_main
```

To run the Wordle recommender:
...
To run all BSTSet tests:

```bash
make test_bst_all
```

To run specific BSTSet test groups:
